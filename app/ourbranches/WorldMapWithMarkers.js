...
const WorldMapWithMarkers = () => {
  useEffect(() => {
    ...
    pointSeries.data.setAll([
      ...
      { title: "Hyderabad", address: "Plot No. 241, 3rd Floor, VVG Elite Developers, Kavuri Hills, Phase - 2, Madhapur, Hyderabad, Telangana - 500081", geometry: { type: "Point", coordinates: [17.4408578 , 78.3916289] } },
